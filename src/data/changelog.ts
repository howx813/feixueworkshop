...
export const changelog: ChangelogEntry[] = [
  {
    version: "0.2.58",
    date: "2026-09-17",
    title: "数据标注卡新增「业务整体」口径（预计收入/回款/成本/毛利 + 收入构成）",
    summary:
      "数据标注卡新增业务整体板块：预计收入 65.8 万、有效回款 50 万、2-7 月成本 36 万、毛利 21%，并按来源列出四项收入构成（AI 公司订单、小辰语料、省电信云中台遵义方言标注、零星结算）。此前卡片只有已签与零星结算口径，整体盘子看不清。",
    items: [
      { tag: "新增", text: "数据标注卡新增「业务整体」四项指标（预计收入/有效回款/2-7月成本/毛利）" },
      { tag: "新增", text: "新增收入构成明细（按客户与项目来源）" },
      { tag: "优化", text: "毛利率标注计算口径（分母为预计收入，未计入牵头人人力成本）" },
    ],
  },
  {
    version: "0.2.57",
    date: "2026-09-17",
    title: "数据标注卡收支板块修订：金额口径统一 + 结余口径区分",
    summary:
      "金额显示统一为两位小数；新增「期间收支结余」与「资金风险」所列「中心资金结余」的口径区分说明，避免两个结余数字并排被误读为矛盾。",
    items: [
      { tag: "优化", text: "收支板块金额统一固定两位小数（原 5,222.6 这类会缺一位）" },
      { tag: "优化", text: "板块标题改为「期间收入与成本」，并说明与「中心资金结余」口径不同、不可直接相抵" },
    ],
  },
  {
    version: "0.2.56",
    date: "2026-09-17",
    title: "数据标注卡新增「收入与成本」月度口径",
    summary:
      "工作看板「数据标注」卡在资金风险下方新增收入与成本板块：按月列出收款、下游采购成本与结余，并给出累计汇总、未付款项提示与结余分摊口径。补上此前一直缺失的收入/成本月度数据，使资金风险可动态跟踪。",
    items: [
      { tag: "新增", text: "数据标注卡新增「收入与成本（月度口径）」板块（2026-04 ~ 2026-08）" },
      { tag: "新增", text: "新增累计收款/下游采购/结余汇总，及未付款项警示" },
      { tag: "新增", text: "新增结余分摊口径（部门基金3%/营销成本15%/直接生产成本3%/团队交付成本79%）" },
      { tag: "优化", text: "data-labeling.json 升 schema v2，新增 finance 字段" },
    ],
  },
  {
    version: "0.2.55",
  ...
  },
  {
    ...
    title: "周报改版为工作看板（四卡片）",
    summary:
      "/weekly 页面改名为工作看板，四张卡片：工作周报（省公司汇报格式，全院口径）、重点工作安排（KPI锚定）、指标看板（生产经营/科创/纪检三维指标）、数据标注（独立专项看板：合同模式/资金风险/年内签约/AI公司相关重点项目/商机储备）。侧栏导航同步改名。",
    items: [
      { tag: "新增", text: "数据标注专项卡片：定位/牵头人、合同模式（4框架）、资金风险、年内签约明细、AI公司相关项目（多模态标注100万/推理工具350万/小辰17.49万/二期）" },
      { tag: "优化", text: "页面改名工作看板，导航同步" },
    ],
  },
  {
    version: "0.2.51",
    date: "2026-08-25",
    title: "重点工作锚定副职考核指标；下线每日工作安排",
    summary:
      "/weekly 页面移除「每日重点工作安排」卡片，只保留周报→重点工作→指标看板。重点工作安排顶部新增4个KPI锚定卡（新签合同60分/收款40分/科创KCI扣分制/纪检114分细则），每个板块标注对应的考核权重与失分重灾区，每条任务标注考核关联。工作流简化：飞雪每周把胡乃伟周报丢给后谷→总结刷新→例会照此安排。",
    items: [
      { tag: "优化", text: "删除每日重点工作安排卡片，聚焦一张表" },
      { tag: "新增", text: "KPI锚定卡：集客合同3000万60分+收款2200万40分现状、科创KCI四项、纪检114分细则及失分重灾区（正面清单0.5/12、线索移交8/10、政治监督15/19）" },
      { tag: "优化", text: "纪检板块补短板导向：建立职能部门线索移送机制（去年丢2分）、政治监督过程记录（去年丢4分）" },
    ],
  },
  {
    version: "0.2.50",
    date: "2026-08-25",
    title: "重点工作安排接入第33-34周例会周报数据",
    summary:
      "根据胡乃伟每周发送的周例会PPT（第33周各部门+第34周全院汇总）刷新重点工作卡片：生产经营9项（Q3合同冲刺1840/3200、贵大478万开标、邮校二期520万、AI标注100万、瓮福磷矿决策等）、科创6项（重大专项化工课题、省级专项资金拨付跟进、数据企业申报补救）、纪检6项（徐昊党课新闻稿待终审、化公为私签字、群腐数据）、党建5项（党员积分上传、巡察支撑）、安全合规5项（XC档案滞后整改、HW-2026收尾）。",
    items: [
      { tag: "优化", text: "生产经营：新增瓮福磷矿不投标决策项、贵大保证金跟踪、安顺学院AI应用200万、信息园4项资金合规等待" },
      { tag: "优化", text: "科创：重大专项课题三磷化→瓮福变更、省级专项拨付跟进、数据企业申报未通过补救" },
      { tag: "优化", text: "纪检：党课新闻稿终审、化公为私差徐总签字、大都督群腐数据、三季度协调小组会议" },
      { tag: "优化", text: "党建：党员二季度积分上传红云、巡察培训材料反馈、青年创新创效案例集" },
      { tag: "优化", text: "安全合规：XC档案归档滞后风险、HW-2026重保收尾、8月网信安分析材料" },
    ],
  },
  {
    version: "0.2.49",
    date: "2026-08-25",
    title: "新增「重点工作安排」卡片（例会主持用）",
    summary:
      "/weekly 新增重点工作安排卡片（独立9822密码）：五板块（生产经营/科创/纪检/党建/安全与合规）共28项任务，每条标注负责人与时间点，顶部例会机制说明（周一例会+各责任人汇报）。数据从商机台账/纪检细则/科创KPI/企微文档盘点推导，飞雪例会可直接照此安排。",
    items: [
      { tag: "新增", text: "生产经营6项：思南医院2000万/电子警察二期/推理工具应标/回款催收/标注中心资金风险/贵大实验室" },
      { tag: "新增", text: "科创6项、纪检7项、党建6项、安全合规4项，全部标注负责人+截止时间" },
      { tag: "优化", text: "页面顺序：周报 → 重点工作 → 每日安排 → 指标看板" },
    ],
  },
  {
    version: "0.2.48",
    date: "2026-08-25",
    title: "新增「每日重点工作安排」卡片",
    summary:
      "/weekly 新增按部门/责任人分组的每日重点工作安排卡片：创新业务部麦著文（合同/回款）、科创综合部杨根琪（科创KCI）、科创综合部侯雅婧（纪检细则与台账），每块含每日/每周任务清单及指标依据，附日报三条数与周五对账机制。",
    items: [
      { tag: "新增", text: "三部门每日/每周任务清单，任务均标注来源指标" },
      { tag: "新增", text: "工作纪律：每日三条数汇报、周五对账、滞后升级机制" },
    ],
  },
  {
    version: "0.2.47",
    date: "2026-08-25",
    title: "指标看板扩展为三板块（集客经营/科创/纪检）",
    summary:
      "副职考核看板升级为「指标看板」：①集客经营（合同/收款+冲刺场景）②科创工作（研发投入/收入/专利/产品库四条扣分制KPI+KCI框架）③纪检工作（23条考核细则按三大类分组展示2025年得分、20条重点工作台账）。安全生产板块预留待接入。",
    items: [
      { tag: "新增", text: "科创工作板块：4项扣分制KPI + KCI 6项/重点任务12项框架说明" },
      { tag: "新增", text: "纪检工作板块：23条细则（政治监督63/正风肃纪20/规范化17+加减分）+ 20条重点工作台账" },
      { tag: "优化", text: "数据 schema 升级 v2：sections 三板块结构，后续可加安全板块" },
    ],
  },
  {
    version: "0.2.46",
  ...
  },
  {
    ...
    summary:
      "/weekly 新增副职考核指标看板：新签合同（3000万/权重60）+ 主营收款（2200万/权重40）双指标卡，季度节点进度条、当前得分、冲刺场景测算、其他考核条线与风险提示；同步将周报密码门从弱密码升级为强密码。",
    items: [
      { tag: "新增", text: "/weekly 副职考核指标看板（合同/收款双指标 + 季度节点进度）" },
      { tag: "新增", text: "收官冲刺场景测算（80分保底 / 90分优秀所需月均签约与回款）" },
      { tag: "新增", text: "其他考核条线（科创/安全/分包费/关闭率/基础管理）状态一览" },
      { tag: "优化", text: "周报密码门弱密码升级为强密码" },
    ],
  },
  {
    version: "0.2.44",
