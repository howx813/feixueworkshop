...
🔬 **科创**：⚠️ 本周无新增科创素材报送（两份来源均不含科创），例会当面补报
❗ **例会须当面确认**：流程中9单办结时间点｜先进计算355万中标结果是否已录入｜慧作业付款流程能否走通｜化公为私材料签字（W37起未反馈）"""

card = {
    "config": {"wide_screen_mode": True},
    "header": {
        "template": "indigo",
        "title": {"tag": "plain_text", "content": "📊 工作看板 · 2026-W38 已更新"},
    },
    "elements": [
...
with open("/tmp/card-w38.json", "w", encoding="utf-8") as f:
